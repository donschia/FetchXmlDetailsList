...
export class DetailsListSample extends React.Component<{}, IDetailsListSampleState> {
    ...
    public componentDidUpdate(previousProps: any, previousState: IDetailsListSampleState) {
